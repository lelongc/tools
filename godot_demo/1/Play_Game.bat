...
echo.
echo   1. KEO VA BAN (SLINGSHOT):
echo      - Nhap va keo lui chu Ca Noc Puffy tren man hinh
echo      - Quan sat duong cham bi vang du doan quy dao bay
echo      - Tha chuot/tay de phong Puffy lao vut di!
echo.
echo   2. KY NANG "TAP-IN-FLIGHT" KHI DANG BAY:
echo      - CHAM 1: PHONG TO DUNG! Hoa bong nay gai nhon sieu dan hoi,
echo                huc vo gach san ho, de bep lu cua cuop bien va nhim gai!
