...
GODOT_PATH = r"D:\app\godot\Godot_v4.7.1-stable_win64.exe"
MCP_SCRIPT = r"C:/Users/Acer/.gemini/antigravity-ide/mcp/godot-mcp/build/index.js"
SSE_SERVER = r"d:\folder\tools\mcp_sse_server.js"

# 1. Tu dong giai phong cong 8080 neu bi chiem dung
try:
    if sys.platform == "win32":
...
print("="*75, flush=True)
print("🚀 DANG KHOI DONG GODOT MCP SERVER & CLOUDFLARE TUNNEL (CHUAN HOA 100%)...", flush=True)
print("="*75, flush=True)
...
# Cho 1.5 giay de server khoi dong
time.sleep(1.5)
...
if tunnel_url:
    print("\n" + "="*75, flush=True)
    print("🎉 KET NOI CLOUDFLARE TUNNEL THANH CONG CHO GODOT MCP!", flush=True)
    print("-"*(75), flush=True)
