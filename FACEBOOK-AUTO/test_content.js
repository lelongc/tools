...
const document = { createElement: () => ({ setAttribute: () => {}, appendChild: () => {}, parentNode: { removeChild: () => {} }, style: {} }), getElementsByTagName: () => [], querySelectorAll: () => [], querySelector: () => null, body: { appendChild: () => {} }, documentElement: {} };
const chrome = { runtime: { onMessage: { addListener: () => {} }, getManifest: () => ({ version: '1.0' }) }, storage: { local: { get: () => {}, set: () => {} } } };
const self = window;
