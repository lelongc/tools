...
def generate_thumbnail(anime_name, topic, output_path="thumbnail.jpg"):
    ...
    base_dir = Path("d:/folder/tools/short/library") / anime_name
...
if __name__ == "__main__":
    import sys
    anime = sys.argv[1] if len(sys.argv) > 1 else "Tensei_Slime"
    topic = sys.argv[2] if len(sys.argv) > 2 else "Is Diablo the Strongest?"
    generate_thumbnail(anime, topic)
